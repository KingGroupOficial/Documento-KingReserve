...
|-------------------------|------------------------|------------------| 
| Trabaja en equipo para proporcionar liderazgo en forma conjunta | 1.- **Sergio André Gómez Vallejos:** <br> -TB1: Participé activamente en el desarrollo del documento y la landing page, colaborando con el equipo en la división de tareas y asegurando que se completaran en el plazo establecido.<br> -TP:** Participé activamente en el desarrollo del documento y la landing page, colaborando con el equipo en la división de tareas y asegurando que se completaran en el plazo establecido. <br> -TF: Participé liderando la integración de las funcionalidades del backend con el frontend de la aplicación, asegurando la coordinación del equipo durante el desarrollo completo del proyecto. <<br>2.- **Maycol Jhordan Rojas Velasquez:** <br> -TB1: Participé activamente en el desarrollo del documento y la landing page colaborando en el tipo de colores y estilos para la web page. En la fase de **TP**, colaboré de manera equitativa para hacer el front end, realizando reuniones y código en conjunto. <br> TP: Participé activamente en el desarrollo del documento y la landing page, colaborando en el tipo de colores y estilos para la web page y el FrontEnd. <br>3.- **Joaquín Pedraza Maldonado:** <br> -TB1: Participé frecuentemente en el documento y en las funcionalidades de la landing page, apoyando a mis compañeros a resolver problemas que se presentaban durante su desarrollo. <br> -TP: Apoyé en el diseño y la funcionalidad del frontend, asegurando la implementación de cambios requeridos por los objetivos del proyecto y colaborando con mis compañeros en sesiones de programación conjunta. <br> -TF:  Estuve a cargo de refinar el diseño visual y trabajé activamente en la integración del frontend con el backend, asegurando que la aplicación cumpliera con los requisitos funcionales y técnicos establecidos. <br> 4.- **Alessandro Netto Zevallos Linares:** <br> -TB1: Participé activamente en la creación del documento, asegurando una correcta coordinación y cumpliendo con los plazos establecidos. <br> -TP: Contribuí de manera activa al desarrollo del documento y la landing page. También apoyé en la implementación de estilos y funcionalidades en el FrontEnd, asegurando que el resultado final cumpliera con las expectativas establecidas. <br> -TF: Contribuí de manera activa en el desarrollo del proyecto mediante la implementación de funcionalidades tanto en el frontend como en el backend. Asimismo, participé en la documentación técnica, asegurando que los procesos fueran claros y reflejaran el trabajo del equipo. <br>5.- **Russell Stephen Romero Qwistgaard:** <br> -TB1: Trabajé en coordinación con mi equipo, siempre estando atento a sus llamadas e intentando entregar mis partes a tiempo. En la fase de **TP**, contribuí de manera significativa al progreso del proyecto al realizar pruebas y analizar el impacto de cada miembro del equipo. <br> -TP: Contribuí significativamente a las pruebas y revisión del proyecto, además de colaborar activamente en reuniones para asegurar que las tareas se ajustaran a los plazos establecidos. <br> TF:** Participe en la creación del sprint 4, además de reevaluar la calidad del informe y de apoyar a mis compañeros en sus partes para evitar que hallan retrasos, concluyendo con la grabación del video about the team. | **TB1:** La colaboración y el liderazgo conjunto permitieron una distribución eficiente de las tareas y aseguraron que se cumplieran los plazos establecidos. La participación activa de todos los miembros del equipo fue crucial para el éxito del proyecto. <br>**TP:** Se asignó colaborativamente el desarrollo del proyecto, logrando un enfoque completo en el segmento objetivo. <br>**TF:** El equipo demostró liderazgo conjunto en la finalización de la aplicación completa, logrando la integración total de frontend y backend. La colaboración activa y el esfuerzo colectivo fueron clave para alcanzar un resultado exitoso.|
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos | 1.- **Sergio André Gómez Vallejos:** <br> -TB1: Contribuí trabajando en equipo, enfocándome en mis tareas asignadas y apoyando a mis compañeros en sus áreas cuando fue necesario, manteniendo una actitud colaborativa para cumplir con los objetivos establecidos. <br> -TP: Contribuí a generar un entorno positivo, cumpliendo con mis tareas asignadas y apoyando a mis compañeros cuando enfrentaron dificultades, para asegurar que los objetivos iniciales del proyecto fueran alcanzados. <br> -TF: En la etapa final, ayudé a establecer prioridades claras para completar el desarrollo de la aplicación. Contribuí a coordinar las tareas relacionadas con la integración de backend y frontend, fomentando un entorno colaborativo que impulsó el éxito del equipo. <br> 2.- **Maycol Jhordan Rojas Velasquez:** <br> -TB1: Creé diversas subtareas para el grupo, permitiendo que todos cumplieran a tiempo con los entregables y generando un entorno más dinámico y amigable. <br> -TP: Organicé subtareas claras para todos los miembros, facilitando la entrega de avances dentro del tiempo estimado y manteniendo un ambiente dinámico y productivo. <br> -TF: Planifiqué actividades específicas para optimizar el desarrollo del proyecto completo, asegurando la calidad del diseño y la funcionalidad del producto. Además, trabajé activamente en la integración final del código y en pruebas para verificar el correcto funcionamiento. <br> 3.- **Joaquín Pedraza Maldonado:** <br> -TB1: Contribuí trabajando en equipo, realizando mis tareas asignadas y escuchando a mis compañeros para generar un buen ambiente de trabajo. <br> -TP: Apoyé en la planificación de tareas específicas para el desarrollo del frontend, proponiendo soluciones a los problemas técnicos y fomentando la colaboración en equipo para cumplir con los objetivos del proyecto. <br> -TF: Mi contribución al proyecto fue corregir los errores que todavía plagaban el informe, además de crear el sprint backlog y archivar cada imagen de evidencia del código. <br> 4.- **Alessandro Netto Zevallos Linares:** <br> -TB1: Me encargué de realizar las tareas asignadas para que el equipo pudiera avanzar de manera eficiente y coordinada, asegurando que los objetivos del proyecto se alcanzaran en los tiempos previstos. <br> -TP: Colaboré activamente en el desarrollo de la aplicación web, aportando tanto en el cumplimiento de mis responsabilidades como en la documentación y el soporte a mis compañeros. <br> -TF: Contribuí activamente en la finalización del proyecto, trabajando en la integración de funcionalidades tanto en el frontend como en el backend. Además, promoví la organización y el trabajo en equipo, facilitando una comunicación eficiente entre los integrantes. Mi enfoque estuvo en garantizar que las metas trazadas se cumplieran. <br> 5.- **Russell Stephen Romero Qwistgaard:** <br> -TB1: Impuse mi trabajo en el proyecto con perseverancia y dedicación, buscando mejorar mi desempeño con cada entrega. <br> -TP: Organicé mis tiempos y estuve atento a las actualizaciones del equipo, además de participar en pruebas de funcionalidad y asegurar la calidad del diseño final. Fomenté la colaboración durante las reuniones y apoyé con revisiones de los entregables. <br> -TF: Contribuí en la grabación del video sobre el equipo, la corrección de los errores en el documento y la realización del sprint 4, promoviendo una mejor organización del equipo y brindando mi ayuda a los demás integrantes del grupo cuando la necesitaban. | **TB1:** La creación de un entorno colaborativo e inclusivo, junto con la planificación y establecimiento de metas claras, permitió al equipo cumplir con los objetivos del proyecto de manera eficiente. La división de tareas y el apoyo mutuo fueron fundamentales para el éxito del Sprint.<br>**TP:** Se trabajó de manera colaborativa en el desarrollo de una buena aplicación web, haciendo que el trabajo fuera un esfuerzo conjunto.<br>**TF:** Durante el desarrollo del proyecto final, el equipo trabajó de manera organizada y coordinada, completando tanto el frontend como el backend de la aplicación. Este esfuerzo conjunto aseguró un producto completo y funcional, alineado con las metas planteadas. |
...
| 3         | US003          | Envío de Correos a los CEO de KingGroup | Como visitante, quiero enviar correos con información adicional sobre las funcionalidades de la aplicación.                                                                                         | 2                |
...
| 8         | US008          | Conexión de King Group con la Aplicación | Como visitante, quiero conocer cómo King Group está conectado con esta aplicación para entender mejor su propósito y origen.                                                                         | 3                |
...
## 5.2.3.4 Sprint Backlog 4

| TS Id  | Title                           | Id   | Description                                                                                      | Estimation | Assigned To | Status      |
|--------|---------------------------------|------|--------------------------------------------------------------------------------------------------|------------|-------------|-------------|
...
| **Link del video:**  https://acortar.link/MZkh0K |
| **Edad:**  31 años |
| **Procedencia:**  Lima, San Isidro |
...
**Link del video:** https://goo.su/XbqR
...
| Despliegue del Back   | https://kingreserve-gqc8ayfabyghb3cw.brazilsouth-01.azurewebsites.net/  |
